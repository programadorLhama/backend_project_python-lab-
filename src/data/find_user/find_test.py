...
def test_by_id_and_user():
    """ Testing by_id_and_user method in FindUser """
    ...
    response = find_user.by_id_and_user(
...
def test_fail_by_id_and_user():
    """ Testing by_id_and_user fail method in FindUser """
